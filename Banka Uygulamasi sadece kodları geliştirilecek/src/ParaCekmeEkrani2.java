...
public final class ParaCekmeEkrani2 {
    ...
    ParaCekmeEkrani2Actions actions = new ParaCekmeEkrani2Actions(this);

    public ParaCekmeEkrani2()
    {
    ...
    public JLabel geriLabel() {
        if(geriLabel == null) {
            ...
            geriLabel.setIcon(new ImageIcon(getClass().getResource()));
