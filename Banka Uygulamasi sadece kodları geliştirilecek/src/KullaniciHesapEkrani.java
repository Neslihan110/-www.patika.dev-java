...
public class KullaniciHesapEkrani implements IPanelAyar {
    ...
    public JLabel getCikisIcon() {
        if (cikisIcon == null) {
            ...
            cikisIcon.setIcon(new ImageIcon(getClass().getResource()));
    ...
    public JLabel getAyarlarIcon() {
        if (ayarlarIcon == null) {
            ...
            ayarlarIcon.setIcon(new ImageIcon(getClass().getResource()));
    ...
    public JLabel getTurkLirasiIcon() {
        if (turkLirasiIcon == null) {
            ...
            turkLirasiIcon.setIcon(new ImageIcon(getClass().getResource()));
    ...
    public JLabel getParaCekIcon() {
        if (paraCekIcon == null) {
            ...
            paraCekIcon.setIcon(new ImageIcon(getClass().getResource()));
        }
        return paraCekIcon;
    }
    ...
    public JLabel getParaYatirIcon() {
        if (paraYatirIcon == null) {
            ...
            paraYatirIcon.setIcon(new ImageIcon(getClass().getResource()));
        }
    ...
    public JLabel getHavaleIcon() {
        if (havaleIcon == null) {
            ...
            havaleIcon.setIcon(new ImageIcon(getClass().getResource()));
        }
        return havaleIcon;
    }
    ...
    public JLabel getOdemelerIcon() {
        if (odemelerIcon == null) {
            ...
            odemelerIcon.setIcon(new ImageIcon(getClass().getResource()));
        }
        return odemelerIcon;
    }
